                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="2">
                                    ...
                                    ?>
                                        ...
                                        <td>
                                        <a href="<?= base_url('index.php/Jenis_kamar/edit_jk/'.$jk->id_jenis);?>" class="bi bi-pencil-square"></a> |
                                        <a href="<?= base_url('index.php/Jenis_kamar/hapus_jk/'.$jk->id_jenis);?>" class="bi bi-trash" onclick="hapus()"></a> 
                                        </td>
                                        </tr>
                                        <?php endforeach ?>
                                        <?php endif ?>
