                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="2">
                                    ...
                                    ?>
                                        ...
                                        <td>
                                        <a href="<?= base_url('index.php/user/edit_user/'.$us->id_user);?>" class="bi bi-pencil-square"></a> | 
                                        <a href="<?= base_url('index.php/user/hapus_user/'.$us->id_user);?>" class="bi bi-trash" onclick="hapus()"></a> 
                                        </td>
                                        </tr>
                                        <?php endforeach ?>
                                        <?php endif ?>
