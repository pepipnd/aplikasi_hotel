                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="2">
                                    ...
                                    ?>
                                        ...
                                        <td>
                                        <a href="<?= base_url('index.php/FasilitasA/edit_fasilitas/'.$fs->id_fasilitas);?>" class="bi bi-pencil-square"> <i class="fa fa-edit"></i></a> |
                                        <a href="<?= base_url('index.php/FasilitasA/hapus_fasilitas/'.$fs->id_fasilitas);?>" class="bi bi-trash" onclick="hapus()"></a> 
                                        </td>
                                        </tr>
                                        <?php endforeach ?>
                                        <?php endif ?>
